    ...
    <div className="flex flex-wrap gap-3">
      {socialLinks.map((link, index) => (
        <a
          ...
          className="flex items-center gap-2 px-3 py-2 bg-surface-50 dark:bg-surface-700 hover:bg-[#1a7a5c]/5 dark:hover:bg-primary-900/30 rounded-lg text-surface-700 dark:text-surface-300 hover:text-[#1a7a5c] dark:hover:text-primary-400 transition-colors duration-200"
          aria-label={`${link.platform} profile`}
        >
          <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
            <path d={platformIcons[link.platform] || platformIcons.website} />
          </svg>
